...
export const StationeryEdit = (props: EditProps) => {
	...
	const handleUpdate = async (values: any) => {
		...
		try {
			...
			await dataProvider.update('stationery', { id, data })
			notify('Успешно обновихте учебника', { type: 'success' })
			redirect(`/admin/stationery/${id}/show`)
		} catch (error) {
			console.error(error)
	...
	return (
		<Edit {...props} title={'Редактиране на артикул'}>
			<Typography
				sx={{
					marginTop: 2,
					textAlign: 'center',
